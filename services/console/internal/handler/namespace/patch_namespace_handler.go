...
func PatchNamespaceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		var req types.PatchNamespaceReq
		if err := httpx.ParseJsonBody(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}
		l := namespace.NewPatchNamespaceLogic(r.Context(), svcCtx)
		resp, err := l.PatchNamespace(slug, &req)
